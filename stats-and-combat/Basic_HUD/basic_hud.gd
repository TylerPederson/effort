...
@onready var ratio_armor = load("res://stats-and-combat/Basic_HUD/Sprites/rfatio_armor.png")
...
@onready var sprint_speed = load("res://stats-and-combat/Basic_HUD/Sprites/health_regen.png")
